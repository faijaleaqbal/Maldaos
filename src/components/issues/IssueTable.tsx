                ...
                <td className="py-3 px-3.5 hidden xl:table-cell text-xs whitespace-nowrap">
                  {issue.assignedTo ? (
                    ...
                    <button
                      ...
                      className="text-amber-800 hover:text-amber-950 font-medium text-xs flex items-center gap-1"
                    >
                ...
                <td className="py-3 px-3.5 text-right whitespace-nowrap">
                  <div className="flex items-center justify-end gap-1.5">
                    ...
                    <Link href={`/issues/${issue.id}`}>
                      <Button size="sm" variant="outline" className="h-7 text-xs px-2" title="Full ticket view">
